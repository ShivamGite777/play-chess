      ...
      >
        ...
        >
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-white">Fast Games</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Quick matches with multiple time controls</p>
          </div>
          
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            <div className="text-2xl mb-2">🌐</div>
            <h3 className="font-semibold text-gray-900 dark:text-white">Real-time</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Live multiplayer with WebSocket</p>
          </div>
          
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            <div className="text-2xl mb-2">🏆</div>
            <h3 className="font-semibold text-gray-900 dark:text-white">Rankings</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">ELO rating system</p>
          </div>
        </motion.div>
      </motion.div>
    </div>
